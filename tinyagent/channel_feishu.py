...
from tinyagent.config import Base, get_media_dir
...
class FeishuChannel(BaseChannel):
    ...
    def __init__(self, config: Any, bus: MessageBus, channel_config: Any = None):
    ...
    def _on_bot_p2p_chat_entered(self, data: Any) -> None:
        logger.info("Bot entered p2p chat (user opened chat window)")
        pass
